        ...
        <div class="main-panel">
            <div class="content-wrapper">
                <div class="Page-header" style="display: flex; justify-content: space-between; align-items: center;">
                    <h5 class="Page-title">Danh sách sinh viên</h5>


                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a href="{{ route('addSinhvien') }}" class="btn btn-sm btn-primary">Thêm sinh
                                    viên</a>
                            </li>
                        </ol>
                    </nav>
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    <div class="row g-3 align-items-center">
                                        <div class="col-auto"><input type="text" id="searchInput" wire:model.live="s"
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                                ...
                                                @foreach ($sinhviens as $sinhvien)
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center">
                                                            <a href="{{ route('editSinhvien', ['id' => $sinhvien->id]) }}"
                                                                class="btn btn-warning"
                                                                style="padding: 5px 15px">Sửa</a>

                                                            <a href="javascrip:void(0)"
                                                                wire:click.prevent="delete ({{ $sinhvien->id }})"
                                            ...
                                            @else
                                                <tr>
                                                    <td colspan="4" style="text-align: center">Không có sinh viên
                                                    </td>
                                                </tr>
                                            @endif
                                        </tbody>
