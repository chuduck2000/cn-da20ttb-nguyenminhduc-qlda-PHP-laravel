                    ...
                    <div class="col-md-5">
                        <div class="card mt-5">
                            <div class="card-header text-center">
                                <h5 class="card-title" style="float:left;">Sửa thông tin giảng viên</h5>
                                <a href="{{ route('giangvien') }}" class="btn btn-sm btn-primary"
                                    style="float: right;">Xem giảng
                                    viên</a>
                            </div>
                            <div class="card-body">
                                ...
                                @endif
                                <form wire:submit.prevent="updateGiangvien">
                                    <div class="form-group">
                                        <label for="exampleInputMSGV1">Mã số giảng viên:</label>
                                        <input type="text" class="form-control" id="exampleInputMSGV1"
                                            wire:model='MSGV'>
                                        @error('MSGV')
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputName1">Họ và tên giảng viên:</label>
                                    ...
                                    <button type="submit" class="btn btn-primary btn-block">Sửa thông tin giảng
                                        viên</button>
                                </form>
                            </div>
                        </div>
