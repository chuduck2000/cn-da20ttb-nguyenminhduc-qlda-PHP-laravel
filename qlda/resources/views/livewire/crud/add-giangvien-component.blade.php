                    ...
                    <div class="col-md-5">
                        <div class="card mt-5">
                            <div class="card-header text-center">
                                <h5 class="card-title" style="float:left;">Thêm giảng viên</h5>
                            ...
                            <div class="card-body">
                                ...
                                @endif
                                <form wire:submit.prevent='addGiangvien'>
                                    ...
                                    <button type="submit" class="btn btn-primary btn-block">Đăng ký giảng
                                        viên</button>
                                </form>
                            </div>
                        </div>
